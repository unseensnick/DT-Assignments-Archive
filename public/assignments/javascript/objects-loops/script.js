...
Task:  
- Use a for...in loop to print all keys and values from the people array in this format:  
...
Task:  
- Use a for...of loop to print a message introducing each person from the people array. 
******************************************************************************/

/****************************************************************************** 
6.1. BONUS:  
- Modify the loop to only print introductions for students (where isStudent === true).  
******************************************************************************/
